...
class Conv2d:
    def __init__(self, input_shape=None, filters=1, kernel_size=(3, 3), isbias=True, activation=None, stride=(1, 1),
                 padding="zero", kernel=None, bias=None):
    ...
    def set_variables(self):
        ...
        self.parameters = ((self.kernel_size[0]*self.kernel_size[1]*self.prev_filters) + (1 if self.isbias else 0)) * self.filters
